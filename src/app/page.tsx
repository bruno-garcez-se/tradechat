...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-[#213365]/5 via-white to-[#eb594c]/5 relative overflow-hidden">
        {/* Efeito de fundo */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2">
              <h1 className="text-4xl md:text-6xl font-bold text-[#213365] mb-6 leading-tight">
                Revolucione seu <span className="text-[#eb594c]">atendimento</span> com o Kanzap
              </h1>
            ...
            <div className="md:w-1/2 mt-12 md:mt-0 flex justify-center items-center relative">
              {/* Efeito de brilho */}
              <div className="absolute inset-0 bg-gradient-to-br from-[#213365]/10 to-[#eb594c]/10 rounded-full filter blur-3xl opacity-30"></div>
              ...
              <Image
                ...
                width={425}
                height={500}
                className="w-full h-auto max-w-[425px] hover:scale-105 transition-transform duration-300 relative z-10"
                priority
              />

              {/* Ícones flutuantes */}
              <div className="absolute -top-8 -left-8 animate-float-slow">
                <div className="bg-[#25D366] p-3 rounded-xl shadow-lg">
              ...
              <div className="absolute top-1/4 -right-8 animate-float-normal">
                <div className="bg-[#1877F2] p-3 rounded-xl shadow-lg">
                  <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="absolute bottom-1/4 -right-4 animate-float-fast">
                <div className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] p-3 rounded-xl shadow-lg">
                  <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#213365] via-[#1a2951] to-[#213365] py-20">
        {/* Efeito de Vidro */}
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className="absolute top-[30%] left-[15%] animate-float-slow">
            <div className="bg-[#25D366] p-4 rounded-2xl shadow-lg transform hover:scale-110 transition-all duration-300">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-3xl mx-auto mb-12">
            ...
            <button
              ...
              className="inline-block bg-white text-[#213365] px-8 py-4 rounded-2xl text-lg font-semibold hover:bg-[#eb594c] hover:text-white transition-all duration-300 transform hover:scale-105 shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgba(235,89,76,0.3)]"
            >
