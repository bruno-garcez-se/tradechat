        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[#213365] mb-6">
              Lei Geral de Proteção de <span className="text-[#eb594c]">Dados</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Entenda como o Kanzap está em conformidade com a LGPD
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              <h2 className="text-2xl font-semibold text-[#213365] mb-4">
                Como o Kanzap se adequa à LGPD?
              </h2>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-[#213365] mb-3">Acesso aos Dados</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-[#213365] mb-3">Correção</h3>
                  <ul className="space-y-2 text-gray-600">
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-[#eb594c] mr-2 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-[#213365]">Criptografia</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-semibold text-[#213365]">Monitoramento</h3>
