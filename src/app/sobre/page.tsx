      ...
      <section className="flex-grow pt-24 pb-20 bg-gradient-to-r from-[#213365]/5 to-[#eb594c]/5">
        <div className="container mx-auto px-6">
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-[#213365] mb-6">
                Nossa História
              </h2>
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-white p-8 rounded-lg shadow-lg">
                  <h3 className="text-xl font-semibold text-[#213365] mb-4">Inovação</h3>
                  <p className="text-gray-600">
                    Buscamos constantemente novas formas de melhorar a experiência de atendimento.
                  </p>
                </div>
                <div className="bg-white p-8 rounded-lg shadow-lg">
                  <h3 className="text-xl font-semibold text-[#213365] mb-4">Excelência</h3>
                  <p className="text-gray-600">
                    Comprometidos com a qualidade em cada interação e funcionalidade.
                  </p>
                </div>
                <div className="bg-white p-8 rounded-lg shadow-lg">
                  <h3 className="text-xl font-semibold text-[#213365] mb-4">Cliente Primeiro</h3>
                  <p className="text-gray-600">
