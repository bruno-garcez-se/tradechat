        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-[#000000] mb-6">
              Sobre o <span className="text-[#3A6604]">TradeChat</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="space-y-6">
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">
                  O TradeChat nasceu da necessidade de simplificar e otimizar o atendimento ao cliente. 
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <ul className="space-y-4 text-gray-600">
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-[#00FF00] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-6">
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <h2 className="text-2xl font-semibold text-[#3A6604] mb-4">
                  Por que escolher o TradeChat?
                </h2>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 bg-[#3A6604]/10 rounded-full flex items-center justify-center">
                        <svg className="w-6 h-6 text-[#3A6604]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                      </div>
                    </div>
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-[#3A6604]">Tecnologia de Ponta</h3>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-[#3A6604]">Segurança Garantida</h3>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-semibold text-[#3A6604]">Suporte Especializado</h3>
